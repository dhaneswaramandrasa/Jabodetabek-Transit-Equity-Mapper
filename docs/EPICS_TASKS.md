...
**Trans-Eng Final Project Track** (separate, no Linear tickets): Report drafted (8,252 words), stop-slop 36/50 (pass). Next: user review, Q&A prep, final submission by June 3. Branch: `trans-eng/final-project-jabodetabek`.
...
- **Notebook**: `notebooks/logit_eda_mle.ipynb` — 56 cells with L06 extensions (logsum, option value, CS, 3 SE estimators, NL vs MNL welfare)
